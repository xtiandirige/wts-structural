...
export default class ReferenceLabels {
    constructor() {
        ...
        this.ALabel = new Graphics({}, { scale: 0.6 }).generateLabel("(0,0)")
        this.BLabel = new Graphics({}, { scale: 0.6 }).generateLabel("(2.5,0)")
        this.CLabel = new Graphics({}, { scale: 0.6 }).generateLabel("(7.5,0)")
        this.DLabel = new Graphics({}, { scale: 0.6 }).generateLabel("(9.0,0)")
